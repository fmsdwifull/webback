...
3） 此工程可以跑起来测试，建议使用chrome、firefox打开。
  全渠道PC网关/WAP支付产品消费交易示例地址为：http://IP：端口/upacp_demo_wtz_token/index_03_token.php
───────────
...
upacp_sdk_php
  ...
  │  ├测试环境证书
  │  │  │  
  │  │  ├acp_test_enc.pfx┈┈┈┈┈┈┈┈┈ ***重要*** 测试环境加密公钥证书（所有商户固定使用同一个）
  │  │  │  
  ...
  │  ├生产环境证书
  │  │  │  
  │  │  ├acp_prod_enc.pfx┈┈┈┈┈┈┈┈┈ ***重要*** 生产环境加密公钥证书（所有商户固定使用同一个）
  │  │  │
  ...
  ├demo ┈┈┈┈┈┈┈┈┈ 示例代码
  │  │  
  │  └api_03_token ┈┈┈┈┈┈┈┈┈ token产品
  │      │  
  │      ├Form_6_2_ApplyToken.php ┈┈┈┈┈ 申请token号示例类
  │      │  
  │      ├Form_6_2_BackOpen.php ┈┈┈┈┈ 后台开通示例类
  │      │  
  │      ├Form_6_2_FrontOpen.php ┈┈┈┈┈ 前台开通示例类
  │      │  
  │      ├Form_6_3_OpenQuery.php ┈┈┈┈┈ 开通状态查询示例类
  │      │  
  │      ├Form_6_4_DeleteToken.php ┈┈┈┈┈ 删除token示例类
  │      │  
  │      ├Form_6_5_UpdateToken.php ┈┈┈┈┈ 更新token示例类
  │      │  
  │      ├Form_6_6_SmsConsume.php ┈┈┈┈┈ 获取消费验证码示例类
  │      │  
  │      ├Form_6_6_SmsOpen.php ┈┈┈┈┈ 获取开通验证码示例类
  │      │  
  │      ├Form_6_7_Consume.php ┈┈┈┈┈ 消费示例类
  │      │  
  │      ├Form_6_7_FrontOpenConsume.php ┈┈┈┈┈ 开通并支付示例类
  │      │  
  │      ├Form_6_8_ConsumeUndo.php ┈┈┈┈┈ 消费撤销示例类
  │      │  
  │      ├Form_6_9_Refund.php ┈┈┈┈┈ 退货示例类
  │      │  
  │      ├Form_6_10_Query.php ┈┈┈┈┈ 交易状态查询示例类
  │      │  
  │      ├Form_7_2_FileTransfer.php┈┈┈┈┈ 对账文件下载示例类 （后台）  
  │      │  
  │      ├BackRcvResponse.php┈┈┈┈┈ 后台通知示例类  
  │      │  
  │      └FrontRcvResponse.php┈┈┈┈┈ 前台通知示例类
  │  
  ├utf8.func┈┈┈┈┈┈sdk以及配置文件
  │  │
